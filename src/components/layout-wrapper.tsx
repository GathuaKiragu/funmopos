        ...
        <div className="min-h-screen bg-black text-white p-4 md:p-8">
            {showHeader && (
                <div className="max-w-4xl mx-auto mb-8 flex items-center justify-between">
                    ...
                    <a href="https://t.me/+0boSnltP4rk4ZjM8" target="_blank" rel="noopener noreferrer" className="ml-2 flex items-center gap-2 text-sm font-bold text-white bg-[#229ED9] hover:bg-[#1e8dbf] transition-all hover:scale-105 active:scale-95 px-4 py-2 rounded-xl shadow-lg shadow-blue-500/20">
